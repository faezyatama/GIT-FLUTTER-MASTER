...
class GaleriChatSupport extends StatefulWidget {
  @override
  _GaleriChatSupportState createState() => new _GaleriChatSupportState();
}

class _GaleriChatSupportState extends State<GaleriChatSupport> {
  ...
  Future<void> cropAndUpdate() async {
    ...
    var uri = Uri.parse('${c.baseURLchat}/mobileApps/kirimGambarChatSupport');
