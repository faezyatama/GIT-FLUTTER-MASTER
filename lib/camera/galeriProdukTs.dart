...
class GaleriProdukTS extends StatefulWidget {
  @override
  _GaleriProdukTSState createState() => new _GaleriProdukTSState();
}

class _GaleriProdukTSState extends State<GaleriProdukTS> {
  ...
  Future<void> cropAndUpdate() async {
    ...
    var uri = Uri.parse('https://images.tokosekitar.com/uploadProduk.php');
