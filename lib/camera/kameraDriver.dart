...
class CameraDriver extends StatefulWidget {
  @override
  _CameraDriverState createState() => new _CameraDriverState();
}

class _CameraDriverState extends State<CameraDriver> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Berkas Pendaftaran Driver'),
      ),
      body: Center(
        child: Container(
          color: Colors.white,
  ...
  Future<void> cropAndUpdate() async {
    ...
    if (c.uploadTo.value == 'profil') {
      link = '${c.baseURLdriver}/mobileAppsMitraDriver/uploadFotoProfilDriver';
    } else {
      link = '${c.baseURLdriver}/mobileAppsMitraDriver/uploadBerkasDriver';
    }
    ...
    if (hasil['status'] == 'success') {
      if (c.uploadTo.value == 'profil') {
        c.fotoProfilDriver.value = hasil['filename'];
      } else if (c.uploadTo.value == 'ktp') {
        c.fotoKtpDriver.value = hasil['filename'];
      } else if (c.uploadTo.value == 'sim') {
        c.fotoSimDriver.value = hasil['filename'];
      } else if (c.uploadTo.value == 'stnk') {
        c.fotoStnkDriver.value = hasil['filename'];
      }
