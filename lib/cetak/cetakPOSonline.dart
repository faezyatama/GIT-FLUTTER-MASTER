...
class TTcetakPOSOnline extends StatefulWidget {
  @override
  _TTcetakPOSOnlineState createState() => _TTcetakPOSOnlineState();
}

class _TTcetakPOSOnlineState extends State<TTcetakPOSOnline> {
