...
class ChannellinkPLAT extends StatefulWidget {
  @override
  _ChannellinkPLATState createState() => _ChannellinkPLATState();
}

class _ChannellinkPLATState extends State<ChannellinkPLAT> {
  final c = Get.find<ApiService>();
  final controllerPin = TextEditingController();
  String cl = 'PLATINUM';
  var grade = 4;
  String harga = 'Rp.5.000.000,-';
  String gambar = 'images/PLATINUM.png';
  String judul = 'Channellink Platinum';
  String subJudul =
