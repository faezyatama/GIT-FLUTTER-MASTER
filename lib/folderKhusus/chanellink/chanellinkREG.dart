...
import 'channellinkGOLD.dart';
import 'channellinkINV.dart';
import 'channellinkSIL.dart';

class ChannellinkREG extends StatefulWidget {
  @override
  _ChannellinkREGState createState() => _ChannellinkREGState();
}

class _ChannellinkREGState extends State<ChannellinkREG> {
  final c = Get.find<ApiService>();
  final controllerPin = TextEditingController();
  String cl = 'REGULER';
  var grade = 1;
  String harga = 'Rp.250.000,-';
  String gambar = 'images/REGULER.png';
  String judul = 'Chanellink Reguler';
  String subJudul =
