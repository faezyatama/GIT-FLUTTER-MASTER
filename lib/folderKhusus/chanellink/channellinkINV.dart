...
class ChannellinkINV extends StatefulWidget {
  @override
  _ChannellinkINVState createState() => _ChannellinkINVState();
}

class _ChannellinkINVState extends State<ChannellinkINV> {
  final c = Get.find<ApiService>();
  final controllerPin = TextEditingController();
  String cl = 'INVINITY';
  var grade = 5;
  String harga = 'Rp.10.000.000,-';
  String gambar = 'images/INVINITY.png';
  String judul = 'Chanellink Invinity';
  String subJudul =
