...
class ChannellinkSIL extends StatefulWidget {
  @override
  _ChannellinkSILState createState() => _ChannellinkSILState();
}

class _ChannellinkSILState extends State<ChannellinkSIL> {
  final c = Get.find<ApiService>();
  final controllerPin = TextEditingController();
  String cl = 'SILVER';
  var grade = 2;
  String harga = 'Rp.1.000.000,-';
  String gambar = 'images/SILVER.png';
  String judul = 'Chanellink Silver';
  String subJudul =
