...
class DaftarPesananDriver extends StatefulWidget {
  DaftarPesananDriver({this.kodePesanan});
  final String kodePesanan;

  @override
  _DaftarPesananDriverState createState() => _DaftarPesananDriverState();
}

class _DaftarPesananDriverState extends State<DaftarPesananDriver> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Detail Antaran'),
      ),
      bottomNavigationBar: Obx(() => Container(
          margin: EdgeInsets.fromLTRB(22, 8, 22, 8),
          height: Get.height * 0.06,
          child: (onProsesAntaran.value == 'Proses')
              ? RawMaterialButton(
                  onPressed: () {
  ...
  rekapBelanjadanAlamat() async {
    ...
    var url = Uri.parse(
        '${c.baseURLdriver}/mobileAppsMitraDriver/detailAntaranBelanjaan');
