...
class DaftarPesananDriverUmum extends StatefulWidget {
  DaftarPesananDriverUmum({this.kodePesanan});
  final String kodePesanan;

  @override
  _DaftarPesananDriverUmumState createState() =>
      _DaftarPesananDriverUmumState();
}

class _DaftarPesananDriverUmumState extends State<DaftarPesananDriverUmum> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Detail Antaran Kurir'),
      ),
      body: ListView(
        children: [
          Container(
  ...
  rekapBelanjadanAlamat() async {
    ...
    var url = Uri.parse(
        '${c.baseURLdriver}/mobileAppsMitraDriver/DetailPesananBarang');
  ...
  void selesaikanPengantaran(String kodeST) async {
    ...
    var url = Uri.parse(
        '${c.baseURLdriver}/mobileAppsMitraDriver/SelesaikanPengantaranViaKurir');
