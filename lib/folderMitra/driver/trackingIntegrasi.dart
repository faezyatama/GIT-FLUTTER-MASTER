...
class TrackingIntegrasi extends StatefulWidget {
  @override
  _TrackingIntegrasiState createState() => _TrackingIntegrasiState();
}

class _TrackingIntegrasiState extends State<TrackingIntegrasi> {
  ...
  cekLokasidanOutlet() async {
    ...
    if (cekin == true) {
      ...
      var url = Uri.parse(
          '${c.baseURLdriver}/mobileAppsMitraDriver/showmapIntegrasi');
