...
class LaporannOfflineFM extends StatefulWidget {
  @override
  _LaporannOfflineFMState createState() => _LaporannOfflineFMState();
}

class _LaporannOfflineFMState extends State<LaporannOfflineFM> {
  ...
  cekLaporan() async {
    ...
    var url =
        Uri.parse('${c.baseURLfreshmart}/mobileAppsOutlet/laporanOfflineFM');
