...
class LaporannOnlineFM extends StatefulWidget {
  @override
  _LaporannOnlineFMState createState() => _LaporannOnlineFMState();
}

class _LaporannOnlineFMState extends State<LaporannOnlineFM> {
  ...
  cekLaporan() async {
    ...
    var url =
        Uri.parse('${c.baseURLfreshmart}/mobileAppsOutlet/laporanOnlineFM');
    ...
    for (var a = 0; a < dataOrder.length; a++) {
      ...
      order.add(Container(
        child: GestureDetector(
          onTap: () {
            Get.to(() => DetailBelanjaanSelesaiFM(kodePesanan: ord[0]));
          },
          child: Card(
              elevation: 0,
              child: Container(
