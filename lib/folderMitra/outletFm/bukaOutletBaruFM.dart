...
class BuatOutletBaruFM extends StatefulWidget {
  @override
  _BuatOutletBaruFMState createState() => _BuatOutletBaruFMState();
}

class _BuatOutletBaruFMState extends State<BuatOutletBaruFM> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Buka Outlet Freshmart'),
        ...
        bottomNavigationBar: Container(
          ...
          child: RawMaterialButton(
            ...
            child: Text(
              'Buka Outlet Freshmart Sekarang',
  ...
  void periksaKelengkapanParameter() {
    if (namaOutlet.value == 'Nama Outlet Kamu ?') {
      ...
      bukaOutletNow('Sasuka Fresh Mart');
    }
  }
  ...
  void bukaOutletNow(String s) async {
    ...
    var url =
        Uri.parse('${c.baseURLfreshmart}/mobileAppsOutlet/bukaOutletFMv2');
  ...
  void cekKodeSSDriver(String ss, String kurir) async {
    ...
    if (response.statusCode == 200) {
      ...
      if (hasil['status'] == 'success') {
        ...
        Get.snackbar('Driver Tidak Ditemukan',
            'Opps.. sepertinya kode driver tidak ditemukan');
      }
    }
  }
}
