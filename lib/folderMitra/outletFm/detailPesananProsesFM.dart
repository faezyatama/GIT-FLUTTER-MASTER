...
class DetailBelanjaanProsesFM extends StatefulWidget {
  DetailBelanjaanProsesFM({this.kodePesanan});
  final String kodePesanan;

  @override
  _DetailBelanjaanProsesFMState createState() =>
      _DetailBelanjaanProsesFMState();
}

class _DetailBelanjaanProsesFMState extends State<DetailBelanjaanProsesFM> {
