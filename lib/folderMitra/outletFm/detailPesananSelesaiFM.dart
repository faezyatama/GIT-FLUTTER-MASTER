...
class DetailBelanjaanSelesaiFM extends StatefulWidget {
  DetailBelanjaanSelesaiFM({this.kodePesanan});
  final String kodePesanan;

  @override
  _DetailBelanjaanSelesaiFMState createState() =>
      _DetailBelanjaanSelesaiFMState();
}

class _DetailBelanjaanSelesaiFMState extends State<DetailBelanjaanSelesaiFM> {
