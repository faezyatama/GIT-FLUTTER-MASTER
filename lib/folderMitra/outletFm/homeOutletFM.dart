...
import 'LaporanFreshmart.dart';
import 'bukaOutletBaruFM.dart';
import 'pengaturanOutletFM.dart';
import 'pesananFM.dart';
import 'produkFM.dart';

class DashboardOutletFM extends StatefulWidget {
  @override
  _DashboardOutletFMState createState() => _DashboardOutletFMState();
}

class _DashboardOutletFMState extends State<DashboardOutletFM> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        bottomNavigationBar: Obx(() => Container(
              ...
              child: (c.adaOutletFMKU.value == 'Ada')
                  ? RawMaterialButton(
                      onPressed: () {
                        if (bukatutup == 'false') {
                          bukaToko('true');
                      ...
                      children: [
                        ...
                        Center(
                          child: Column(
                            children: [
                              Obx(() => Text(
                                    c.namaOutletFMKU.value,
                                    style: styleHurufBesar,
                                    textAlign: TextAlign.center,
                                  )),
                              Obx(() => Text(
                                    c.alamatOutletFMKU.value,
                                    style: styleHuruf1,
                                    textAlign: TextAlign.center,
                                  )),
                              Obx(() => Text(
                                    c.kabupatenFMKU.value,
                                    style: styleHuruf1,
                                    textAlign: TextAlign.center,
                                  )),
                            ],
                          ...
                          child: Center(
                            child: Column(
                              children: [
                                ...
                                Text(
                                  'Sepertinya kamu belum memiliki Outlet Freshmart',
                                  style: styleHurufBesar,
                                  textAlign: TextAlign.center,
                                ),
                                Padding(padding: EdgeInsets.only(top: 22)),
                                Text(
                                  'Mudah loh berjualan Sayuran, Bumbu Dapur, dan Sembako di ${c.namaAplikasi}, Cukup ikuti beberapa langkah mudah dan Outlet Freshmart Online kamu akan segera aktif',
                                  style: styleHuruf1,
                                  textAlign: TextAlign.center,
                                ),
                                Padding(padding: EdgeInsets.only(top: 22)),
  ...
  void cekAdaOutletGak() async {
    ...
    var url =
        Uri.parse('${c.baseURLfreshmart}/mobileAppsOutlet/punyaOutletTidakFM');
    ...
    if (response.statusCode == 200) {
      ...
      if (hasil['status'] == 'success') {
        if (hasil['outlet'] == 'Ada') {
          setState(() {
            dataReady = true;
            c.adaOutletFMKU.value = hasil['outlet'];
  ...
  void bukaToko(String s) async {
    ...
    var url = Uri.parse('${c.baseURLfreshmart}/mobileAppsOutlet/bukaTutupFM');
