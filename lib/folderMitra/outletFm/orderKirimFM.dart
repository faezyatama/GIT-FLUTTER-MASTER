...
import 'detailPesananKirimFM.dart';

class OrderKirimFM extends StatefulWidget {
  @override
  _OrderKirimFMState createState() => _OrderKirimFMState();
}

class _OrderKirimFMState extends State<OrderKirimFM> {
  ...
  cekOrderBerlangsung() async {
    ...
    var url =
        Uri.parse('${c.baseURLfreshmart}/mobileAppsOutlet/listOrderKirimFM');
      ...
      order.add(Container(
        child: GestureDetector(
          child: Card(
              child: GestureDetector(
            onTap: () {
              Get.to(() => DetailBelanjaanKirimFM(kodePesanan: ord[6]));
            },
            child: Container(
