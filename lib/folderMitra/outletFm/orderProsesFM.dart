...
import 'detailPesananProsesFM.dart';

class OrderProsesFM extends StatefulWidget {
  @override
  _OrderProsesFMState createState() => _OrderProsesFMState();
}

class _OrderProsesFMState extends State<OrderProsesFM> {
  ...
  cekOrderBerlangsung() async {
    ...
    var url =
        Uri.parse('${c.baseURLfreshmart}/mobileAppsOutlet/listOrderProsesFM');
      ...
      order.add(Container(
        child: GestureDetector(
          child: Card(
              child: GestureDetector(
            onTap: () {
              Get.to(() => DetailBelanjaanProsesFM(kodePesanan: ord[6]));
            },
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      Get.to(
                          () => DetailBelanjaanProsesFM(kodePesanan: ord[6]));
                    },
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
