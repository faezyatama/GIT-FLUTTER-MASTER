...
import 'detailPesananSelesaiFM.dart';

class OrderSelesaiFM extends StatefulWidget {
  @override
  _OrderSelesaiFMState createState() => _OrderSelesaiFMState();
}

class _OrderSelesaiFMState extends State<OrderSelesaiFM> {
  ...
  cekOrderBerlangsung() async {
    ...
    var url =
        Uri.parse('${c.baseURLfreshmart}/mobileAppsOutlet/listOrderSelesaiFM');
      ...
      order.add(Container(
        child: GestureDetector(
          child: Card(
              child: GestureDetector(
            onTap: () {
              Get.to(() => DetailBelanjaanSelesaiFM(kodePesanan: ord[6]));
            },
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      Get.to(
                          () => DetailBelanjaanSelesaiFM(kodePesanan: ord[6]));
                    },
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
