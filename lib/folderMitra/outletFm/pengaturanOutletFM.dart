...
import 'petaOutletFM.dart';

class PengaturanOutletFM extends StatefulWidget {
  @override
  _PengaturanOutletFMState createState() => _PengaturanOutletFMState();
}

class _PengaturanOutletFMState extends State<PengaturanOutletFM> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
            title: Text('Atur Outlet Freshmart'),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        Get.to(() => SetLokasiOutletFM());
                      },
                      child: Obx(() => Row(
                            children: [
                              SizedBox(
                                  width: Get.width * 0.6,
                                  child: (c.latOutletFMKU.value == 0.0)
                                      ? Text(
                                      ...
                                      : Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              'GPS : ' +
                                                  c.latOutletFMKU.value
                                                      .toString() +
                                                  ' / ' +
                                                  c.longOutletFMKU.value
                                                      .toString(),
                                              style: styleHurufkecil,
                                            ),
                                          ],
  ...
  provinsiCek() async {
    ...
    var url = Uri.parse('${c.baseURLfreshmart}/mobileAppsOutlet/provinsi');
  ...
  void kabupatenCek(String propValue) async {
    ...
    var url = Uri.parse('${c.baseURLfreshmart}/mobileAppsOutlet/kabupaten');
  ...
  void kecamatanCek(String kab) async {
    ...
    var url = Uri.parse('${c.baseURLfreshmart}/mobileAppsOutlet/kecamatan');
  ...
  void periksaKelengkapanParameter() {
    if (namaOutlet.value == 'Nama Outlet Kamu ?') {
      ...
      errorParameter('Pilih Kecamatan tempat outlet kamu berada');
    } else if (c.latOutletFMKU.value == 0.0) {
      errorParameter(
          'Opps.. Sepertinya kamu belum menentukan lokasi outlet kamu pada peta');
    } else {
      updateOutletNow('Sasuka Fresh Mart');
    }
  }
  ...
  void updateOutletNow(String s) async {
    ...
    var latOutletku = c.latOutletFMKU.value;
    var longOutletku = c.longOutletFMKU.value;
    ...
    if (response.statusCode == 200) {
      ...
      if (hasil['status'] == 'success') {
        ...
        AwesomeDialog(
          ...
          btnOkText: 'OK',
          btnOkOnPress: () {
            c.adaOutletFMKU.value = 'Ada';
            var detailOutlet = hasil['detailOutlet'];
            c.namaOutletFMKU.value = detailOutlet[0];
            c.alamatOutletFMKU.value = detailOutlet[1];
            c.kabupatenFMKU.value = detailOutlet[2];
            c.deskripsiFMKU.value = detailOutlet[3];
            c.kunjunganFMKU.value = detailOutlet[4];
            c.terjualFMKU.value = detailOutlet[5];
            c.produkFMKU.value = detailOutlet[6];
            Get.back();
          },
        )..show();
      } else {
  ...
  void cekKodeSSDriver(String ss, String kurir) async {
    ...
    var url = Uri.parse(
        '${c.baseURLfreshmart}/mobileAppsOutlet/cekSSDriverIntegrasiFM');
  ...
  void cekAwalOutletDetail() async {
    ...
    var datarequest = '{"pid":"$pid","jenis":"Sasuka Fresh Mart"}';
    var bytes = utf8.encode(datarequest + '$token' + user);
    var signature = md5.convert(bytes).toString();

    var url =
        Uri.parse('${c.baseURLfreshmart}/mobileAppsOutlet/cekAwalDataOutletFM');
    ...
    if (response.statusCode == 200) {
      ...
      if (hasil['status'] == 'success') {
        ...
        setState(() {
          ...
          c.latOutletFMKU.value = detoutlet[6];
          c.longOutletFMKU.value = detoutlet[7];
