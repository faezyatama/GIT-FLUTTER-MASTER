...
class SetLokasiOutletFM extends StatefulWidget {
  @override
  _SetLokasiOutletFMState createState() => _SetLokasiOutletFMState();
}

class _SetLokasiOutletFMState extends State<SetLokasiOutletFM> {
              ...
              children: [
                ...
                Row(
                  children: [
                    ElevatedButton(
                        onPressed: () {
                          c.latOutletFMKU.value = c.tempLat.value;
                          c.longOutletFMKU.value = c.tempLong.value;
                          Get.back();
                        },
  ...
  void carilokasigoogle() async {
    ...
    var url =
        Uri.parse('${c.baseURLfreshmart}/mobileAppsOutlet/cekalamatgoogle');
