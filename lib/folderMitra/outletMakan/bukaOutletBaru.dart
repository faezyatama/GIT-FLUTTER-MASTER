...
class BuatOutletBaru extends StatefulWidget {
  @override
  _BuatOutletBaruState createState() => _BuatOutletBaruState();
}

class _BuatOutletBaruState extends State<BuatOutletBaru> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
            title: Text('Buka Outlet Kuliner'),
  ...
  void bukaOutletNow(String s) async {
    ...
    var url = Uri.parse('${c.baseURLmakan}/mobileAppsOutlet/bukaOutlet');
