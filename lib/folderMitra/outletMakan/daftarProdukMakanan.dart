...
import 'editProdukMakanan.dart';

class DaftarProdukMakanan extends StatefulWidget {
  @override
  _DaftarProdukMakananState createState() => _DaftarProdukMakananState();
}

class _DaftarProdukMakananState extends State<DaftarProdukMakanan> {
                ...
                ? Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                          'Sepertinya kamu belum memiliki daftar menu yang akan dijual',
  ...
  cekOrderBerlangsung() async {
    ...
    var url = Uri.parse('${c.baseURLmakan}/mobileAppsOutlet/listProdukMakanan');
  ...
  void editHapus(String j, String itemid) {
    AwesomeDialog(
        ...
        btnOkOnPress: () {
          c.itemEditPilihan.value = itemid;
          Get.to(() => EditProdukMakanan());
        })
      ..show();
  }
  ...
  void prosesJual(String s, String itemid) async {
    ...
    var url = Uri.parse('${c.baseURLmakan}/mobileAppsOutlet/jualTidak');
  ...
  void hapusProduk(String itemid) async {
    ...
    var url = Uri.parse('${c.baseURLmakan}/mobileAppsOutlet/hapusProduk');
