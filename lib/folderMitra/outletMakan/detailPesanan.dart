...
class _DetailBelanjaanState extends State<DetailBelanjaan> {
  ...
  void terimaOrderIni(String kodetrx) async {
    ...
    var url = Uri.parse('${c.baseURLmakan}/mobileAppsOutlet/terimaOrderMakan');
      ...
      if (hasil['status'] == 'success') {
        ...
        if (mounted) {
          AwesomeDialog(
            ...
            btnOkText: 'OK SIAP',
            btnOkOnPress: () {
              c.selectedIndexOrderMakanan.value = 1;
              Get.back();
              Get.back();
        ...
        Get.snackbar('Tidak dapat diproses',
            'Order tidak dapat diproses silahkan ulangi proses ini');
        Get.back();
      }
    }
  }
  ...
  void tolakOrderIni(String kodePesanan) async {
    ...
    var url = Uri.parse('${c.baseURLmakan}/mobileAppsOutlet/tolakOrderMakan');
