...
class DetailBelanjaanKirim extends StatefulWidget {
  DetailBelanjaanKirim({this.kodePesanan});
  final String kodePesanan;

  @override
  _DetailBelanjaanKirimState createState() => _DetailBelanjaanKirimState();
}

class _DetailBelanjaanKirimState extends State<DetailBelanjaanKirim> {
