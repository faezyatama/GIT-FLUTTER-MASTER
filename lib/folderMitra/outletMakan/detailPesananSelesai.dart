...
class DetailBelanjaanSelesai extends StatefulWidget {
  DetailBelanjaanSelesai({this.kodePesanan});
  final String kodePesanan;

  @override
  _DetailBelanjaanSelesaiState createState() => _DetailBelanjaanSelesaiState();
}

class _DetailBelanjaanSelesaiState extends State<DetailBelanjaanSelesai> {
