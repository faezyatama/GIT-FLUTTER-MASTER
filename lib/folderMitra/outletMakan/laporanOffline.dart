...
class LaporanOfflineMakanan extends StatefulWidget {
  @override
  _LaporanOfflineMakananState createState() => _LaporanOfflineMakananState();
}

class _LaporanOfflineMakananState extends State<LaporanOfflineMakanan> {
  ...
  cekLaporan() async {
    ...
    var url =
        Uri.parse('${c.baseURLmakan}/mobileAppsOutlet/laporanOfflineMakan');
