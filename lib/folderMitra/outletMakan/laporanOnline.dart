...
class LaporanOnlineMakanan extends StatefulWidget {
  @override
  _LaporanOnlineMakananState createState() => _LaporanOnlineMakananState();
}

class _LaporanOnlineMakananState extends State<LaporanOnlineMakanan> {
  ...
  cekLaporan() async {
    ...
    var url =
        Uri.parse('${c.baseURLmakan}/mobileAppsOutlet/laporanOnlineMakan');
    ...
    for (var a = 0; a < dataOrder.length; a++) {
      ...
      order.add(Container(
        child: GestureDetector(
          onTap: () {
            Get.to(() => DetailBelanjaanSelesai(kodePesanan: ord[0]));
          },
          child: Card(
              elevation: 0,
              child: Container(
