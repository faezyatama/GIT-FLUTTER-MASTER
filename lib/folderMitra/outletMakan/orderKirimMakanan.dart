...
import 'detailPesananKirim.dart';

class OrderKirimMakanan extends StatefulWidget {
  @override
  _OrderKirimMakananState createState() => _OrderKirimMakananState();
}

class _OrderKirimMakananState extends State<OrderKirimMakanan> {
                ...
                ? Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                          'Sepertinya kamu belum memiliki pesanan yang dalam proses pengiriman',
  ...
  cekOrderBerlangsung() async {
    ...
    var url = Uri.parse('${c.baseURLmakan}/mobileAppsOutlet/listOrderKirimMK');
    ...
    if (response.statusCode == 200) {
      ...
      if (hasil['status'] == 'success') {
        ...
        c.stMasukMK.value = hasil['masuk'];
        c.stProsesMK.value = hasil['proses'];
        c.stKirimMK.value = hasil['kirim'];
        if (mounted) {
          setState(() {
            dataSiap = true;
      ...
      order.add(Container(
        child: GestureDetector(
          child: Card(
              child: GestureDetector(
            onTap: () {
              Get.to(() => DetailBelanjaanKirim(kodePesanan: ord[6]));
            },
            child: Container(
