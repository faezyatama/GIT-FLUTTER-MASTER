...
class OrderMasukMakanan extends StatefulWidget {
  @override
  _OrderMasukMakananState createState() => _OrderMasukMakananState();
}

class _OrderMasukMakananState extends State<OrderMasukMakanan> {
  ...
  cekOrderBerlangsung() async {
    ...
    var url = Uri.parse('${c.baseURLmakan}/mobileAppsOutlet/listOrderMasukMK');
      ...
      order.add(Container(
        child: GestureDetector(
          child: Card(
              child: GestureDetector(
            onTap: () {
              Get.to(() => DetailBelanjaan(kodePesanan: ord[3]));
            },
            child: Container(
