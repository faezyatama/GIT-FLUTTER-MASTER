...
import 'detailPesananProses.dart';

class OrderProsesMakanan extends StatefulWidget {
  @override
  _OrderProsesMakananState createState() => _OrderProsesMakananState();
}

class _OrderProsesMakananState extends State<OrderProsesMakanan> {
  ...
  cekOrderBerlangsung() async {
    ...
    var url = Uri.parse('${c.baseURLmakan}/mobileAppsOutlet/listOrderProsesMK');
      ...
      order.add(Container(
        child: GestureDetector(
          child: Card(
              child: GestureDetector(
            onTap: () {
              Get.to(() => DetailBelanjaanProses(kodePesanan: ord[6]));
            },
            child: Container(
