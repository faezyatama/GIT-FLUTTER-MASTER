...
import 'detailPesananSelesai.dart';

class OrderSelesaiMakanan extends StatefulWidget {
  @override
  _OrderSelesaiMakananState createState() => _OrderSelesaiMakananState();
}

class _OrderSelesaiMakananState extends State<OrderSelesaiMakanan> {
  ...
  cekOrderBerlangsung() async {
    ...
    var url =
        Uri.parse('${c.baseURLmakan}/mobileAppsOutlet/listOrderSelesaiMK');
      ...
      order.add(Container(
        child: GestureDetector(
          child: Card(
              child: GestureDetector(
            onTap: () {
              Get.to(() => DetailBelanjaanSelesai(kodePesanan: ord[6]));
            },
            child: Container(
