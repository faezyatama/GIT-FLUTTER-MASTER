...
class TambahProdukMakanan extends StatefulWidget {
  @override
  _TambahProdukMakananState createState() => _TambahProdukMakananState();
}

class _TambahProdukMakananState extends State<TambahProdukMakanan> {
  ...
  void prosesTambahProdukBaru() async {
    ...
    var datarequest =
        '{"pid":"$pid","pic6":"$pic6","pic5":"$pic5","pic4":"$pic4","pic3":"$pic3","pic2":"$pic2","pic1":"$pic1","pos":"$pos","jet":"$jet","sicepat":"$sicepat","jnt":"$jnt","jne":"$jne","intg":"$intg","ssik":"$ssik","namaProduk":"$namaProduk","des":"$des","kategori":"$kate","berat":"$berat","harga":"$harga","stok":"$stok","kondisi":"$kon"}';
    var bytes = utf8.encode(datarequest + '$token' + user);
    var signature = md5.convert(bytes).toString();

    var url = Uri.parse(
        '${c.baseURLmakan}/mobileAppsOutlet/buatItemBaruMakananBase64');
