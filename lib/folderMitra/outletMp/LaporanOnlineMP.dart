...
class LaporannOnlineMP extends StatefulWidget {
  @override
  _LaporannOnlineMPState createState() => _LaporannOnlineMPState();
}

class _LaporannOnlineMPState extends State<LaporannOnlineMP> {
  ...
  cekLaporan() async {
    ...
    var url = Uri.parse('${c.baseURLmp}/mobileAppsOutlet/laporanOnlineMP');
    ...
    for (var a = 0; a < dataOrder.length; a++) {
      ...
      order.add(Container(
        child: GestureDetector(
          onTap: () {
            Get.to(() => DetailBelanjaanSelesaiMP(kodePesanan: ord[0]));
          },
          child: Card(
              elevation: 0,
              child: Container(
