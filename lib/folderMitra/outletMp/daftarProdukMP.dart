...
import 'editProdukMP.dart';

class DaftarProdukMP extends StatefulWidget {
  @override
  _DaftarProdukMPState createState() => _DaftarProdukMPState();
}

class _DaftarProdukMPState extends State<DaftarProdukMP> {
  ...
  cekOrderBerlangsung() async {
    ...
    var url = Uri.parse('${c.baseURLmp}/mobileAppsOutlet/listProdukMP');
          ...
          child: Card(
            ...
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    var gambar = 'https://images.sasuka.online/200/' + ord[0];
                    editHapus('${ord[2]}', '${ord[6]}', gambar, '${ord[4]}');
                  },
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
  ...
  void editHapus(String j, String itemid, String gambarKu, String kategori) {
    AwesomeDialog(
        context: Get.context,
        ...
        btnOkOnPress: () {
          c.itemEditPilihanMPKU.value = itemid;
          Get.to(() => EditProdukMP());
        })
      ..show();
  }
  ...
  void prosesJual(String s, String itemid) async {
    ...
    var url = Uri.parse('${c.baseURLmp}/mobileAppsOutlet/jualTidakMP');
  ...
  void hapusProduk(String itemid) async {
    ...
    var url = Uri.parse('${c.baseURLmp}/mobileAppsOutlet/hapusProdukMP');
