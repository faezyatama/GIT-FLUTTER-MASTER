...
class DetailBelanjaanKirimMP extends StatefulWidget {
  DetailBelanjaanKirimMP({this.kodePesanan});
  final String kodePesanan;

  @override
  _DetailBelanjaanKirimMPState createState() => _DetailBelanjaanKirimMPState();
}

class _DetailBelanjaanKirimMPState extends State<DetailBelanjaanKirimMP> {
