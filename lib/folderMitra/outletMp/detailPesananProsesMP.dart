...
class DetailBelanjaanProsesMP extends StatefulWidget {
  DetailBelanjaanProsesMP({this.kodePesanan});
  final String kodePesanan;

  @override
  _DetailBelanjaanProsesMPState createState() =>
      _DetailBelanjaanProsesMPState();
}

class _DetailBelanjaanProsesMPState extends State<DetailBelanjaanProsesMP> {
  ...
  void siapKirimPesanan(String kodetrx) async {
    ...
    var url = Uri.parse('${c.baseURLmp}/mobileAppsOutlet/pesananSiapKirimMP');
      ...
      if (hasil['status'] == 'success') {
        ...
        if (mounted) {
          AwesomeDialog(
            ...
            btnOkText: 'OK SIAP',
            btnOkOnPress: () {
              c.selectedIndexOrderMPKU.value = 2;
              Get.back();
              Get.back();
              Get.to(() => PesananMP());
            },
