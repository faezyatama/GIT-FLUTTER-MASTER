...
class DetailBelanjaanSelesaiMP extends StatefulWidget {
  DetailBelanjaanSelesaiMP({this.kodePesanan});
  final String kodePesanan;

  @override
  _DetailBelanjaanSelesaiMPState createState() =>
      _DetailBelanjaanSelesaiMPState();
}

class _DetailBelanjaanSelesaiMPState extends State<DetailBelanjaanSelesaiMP> {
