...
import 'detailPesananKirimMP.dart';

class OrderKirimMP extends StatefulWidget {
  @override
  _OrderKirimMPState createState() => _OrderKirimMPState();
}

class _OrderKirimMPState extends State<OrderKirimMP> {
  ...
  cekOrderBerlangsung() async {
    ...
    var url = Uri.parse('${c.baseURLmp}/mobileAppsOutlet/listOrderKirimMP');
      ...
      order.add(Container(
        child: GestureDetector(
          child: Card(
              child: GestureDetector(
            onTap: () {
              Get.to(() => DetailBelanjaanKirimMP(kodePesanan: ord[6]));
            },
            child: Container(
