...
import 'detailPesananMP.dart';

class OrderMasukMP extends StatefulWidget {
  @override
  _OrderMasukMPState createState() => _OrderMasukMPState();
}

class _OrderMasukMPState extends State<OrderMasukMP> {
  ...
  cekOrderBerlangsung() async {
    ...
    var url = Uri.parse('${c.baseURLmp}/mobileAppsOutlet/listOrderMasukMP');
      ...
      order.add(Container(
        child: GestureDetector(
          child: Card(
              child: GestureDetector(
            onTap: () {
              Get.to(() => DetailBelanjaanMP(kodePesanan: ord[3]));
            },
            child: Container(
