...
import 'detailPesananProsesMP.dart';

class OrderProsesMP extends StatefulWidget {
  @override
  _OrderProsesMPState createState() => _OrderProsesMPState();
}

class _OrderProsesMPState extends State<OrderProsesMP> {
  ...
  cekOrderBerlangsung() async {
    ...
    var url = Uri.parse('${c.baseURLmp}/mobileAppsOutlet/listOrderProsesMP');
      ...
      order.add(Container(
        child: GestureDetector(
          child: Card(
              child: GestureDetector(
            onTap: () {
              Get.to(() => DetailBelanjaanProsesMP(kodePesanan: ord[6]));
            },
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      Get.to(
                          () => DetailBelanjaanProsesMP(kodePesanan: ord[6]));
                    },
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
