...
import 'detailPesananSelesaiMP.dart';

class OrderSelesaiMP extends StatefulWidget {
  @override
  _OrderSelesaiMPState createState() => _OrderSelesaiMPState();
}

class _OrderSelesaiMPState extends State<OrderSelesaiMP> {
                ...
                ? Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                          'Sepertinya kamu belum memiliki pesanan yang telah diselesaikan',
  ...
  cekOrderBerlangsung() async {
    ...
    var url = Uri.parse('${c.baseURLmp}/mobileAppsOutlet/listOrderSelesaiMP');
      ...
      order.add(Container(
        child: GestureDetector(
          child: Card(
              child: GestureDetector(
            onTap: () {
              Get.to(() => DetailBelanjaanSelesaiMP(kodePesanan: ord[6]));
            },
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      Get.to(
                          () => DetailBelanjaanSelesaiMP(kodePesanan: ord[6]));
                    },
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
