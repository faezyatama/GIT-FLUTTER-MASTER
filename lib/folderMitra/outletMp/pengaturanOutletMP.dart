...
class PengaturanOutletMP extends StatefulWidget {
  @override
  _PengaturanOutletMPState createState() => _PengaturanOutletMPState();
}

class _PengaturanOutletMPState extends State<PengaturanOutletMP> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Atur Outlet / Toko Online'),
        ),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Kamu bisa mengatur nama Toko Online kamu disini, Caranya cukup klik Nama Toko dan edit sesuai keinginan kamu.',
  ...
  void updateOutletNow(String s) async {
    ...
    var url = Uri.parse('${c.baseURLmp}/mobileAppsOutlet/updateOutletMPv2');
  ...
  void cekAwalOutletDetail() async {
    ...
    var datarequest = '{"pid":"$pid","jenis":"Sasuka Mall"}';
    var bytes = utf8.encode(datarequest + '$token' + user);
    var signature = md5.convert(bytes).toString();

    var url = Uri.parse('${c.baseURLmp}/mobileAppsOutlet/cekAwalDataOutletMP');
    ...
    if (response.statusCode == 200) {
      ...
      if (hasil['status'] == 'success') {
        ...
        setState(() {
          ...
          pilihanOffline = detoutlet[14];
          c.latOutletMPKU.value = detoutlet[6];
          c.longOutletMPKU.value = detoutlet[7];
