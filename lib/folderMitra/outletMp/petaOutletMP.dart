...
class SetLokasiOutletMP extends StatefulWidget {
  @override
  _SetLokasiOutletMPState createState() => _SetLokasiOutletMPState();
}

class _SetLokasiOutletMPState extends State<SetLokasiOutletMP> {
              ...
              children: [
                ...
                Row(
                  children: [
                    ElevatedButton(
                        onPressed: () {
                          c.latOutletMPKU.value = c.tempLat.value;
                          c.longOutletMPKU.value = c.tempLong.value;
                          Get.back();
                        },
  ...
  void carilokasigoogle() async {
    ...
    var url = Uri.parse('${c.baseURLmp}/mobileAppsOutlet/cekalamatgoogle');
