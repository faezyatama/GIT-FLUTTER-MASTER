...
class LaporanJualDetail extends StatefulWidget {
  @override
  _LaporanJualDetailState createState() => _LaporanJualDetailState();
}

class _LaporanJualDetailState extends State<LaporanJualDetail> {
  ...
  cekLaporan() async {
    ...
    var url = Uri.parse(
        '${c.baseURLtokosekitar}/mobileAppsOutlet/laporanPenjualanDetail');
