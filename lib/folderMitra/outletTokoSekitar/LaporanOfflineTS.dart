...
import 'LaporanJualDetail.dart';

class LaporannOfflineTS extends StatefulWidget {
  @override
  _LaporannOfflineTSState createState() => _LaporannOfflineTSState();
}

class _LaporannOfflineTSState extends State<LaporannOfflineTS> {
  ...
  cekLaporan() async {
    ...
    var url =
        Uri.parse('${c.baseURLtokosekitar}/mobileAppsOutlet/laporanOfflineTS');
