...
class POSthumbList extends StatefulWidget {
  @override
  _POSthumbListState createState() => _POSthumbListState();
}

class _POSthumbListState extends State<POSthumbList> {
  ...
  cekOrderBerlangsung() async {
    ...
    var url = Uri.parse('${c.baseURL}/sasuka/listOrderSelesaiFM');
