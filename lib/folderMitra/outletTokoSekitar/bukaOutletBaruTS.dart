...
class BuatOutletBaruTS extends StatefulWidget {
  @override
  _BuatOutletBaruTSState createState() => _BuatOutletBaruTSState();
}

class _BuatOutletBaruTSState extends State<BuatOutletBaruTS> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: ListView(children: [
          Container(
            margin: EdgeInsets.fromLTRB(8, 11, 8, 11),
            child: Card(
              child: Container(
  ...
  void kecamatanCek(String kab) async {
    ...
    var url = Uri.parse('${c.baseURLtokosekitar}/mobileAppsOutlet/kecamatan');
  ...
  void bukaOutletNow(String s) async {
    ...
    var url =
        Uri.parse('${c.baseURLtokosekitar}/mobileAppsOutlet/bukaOutletTS');
