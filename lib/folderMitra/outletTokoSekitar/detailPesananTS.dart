...
class DetailBelanjaanTS extends StatefulWidget {
  DetailBelanjaanTS({this.kodePesanan});
  final String kodePesanan;

  @override
  _DetailBelanjaanTSState createState() => _DetailBelanjaanTSState();
}

class _DetailBelanjaanTSState extends State<DetailBelanjaanTS> {
  ...
  rekapBelanjadanAlamat() async {
    ...
    var url = Uri.parse(
        '${c.baseURLtokosekitar}/mobileAppsOutlet/detailBelanjaanTokoSekitar');
  ...
  void terimaOrderIni(String kodetrx) async {
    ...
    var url =
        Uri.parse('${c.baseURLtokosekitar}/mobileAppsOutlet/terimaOrderTS');
