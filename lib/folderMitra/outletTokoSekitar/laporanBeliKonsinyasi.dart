...
import 'laporanBeliDetailKonsinyasi.dart';

class LaporanBeliKonsinyasi extends StatefulWidget {
  @override
  _LaporanBeliKonsinyasiState createState() => _LaporanBeliKonsinyasiState();
}

class _LaporanBeliKonsinyasiState extends State<LaporanBeliKonsinyasi> {
  ...
  cekLaporan() async {
    ...
    var url = Uri.parse(
        '${c.baseURLtokosekitar}/mobileAppsOutlet/laporanPembelianKonsinyasi');
      ...
      order.add(Container(
        child: GestureDetector(
          onTap: () {
            ...
            Get.to(() => LaporanDetailKonsinyasi());
          },
          child: Card(
              elevation: 0,
              child: Container(
