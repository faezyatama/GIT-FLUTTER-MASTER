...
class LaporanBeliLunas extends StatefulWidget {
  @override
  _LaporanBeliLunasState createState() => _LaporanBeliLunasState();
}

class _LaporanBeliLunasState extends State<LaporanBeliLunas> {
  ...
  cekLaporan() async {
    ...
    var url = Uri.parse(
        '${c.baseURLtokosekitar}/mobileAppsOutlet/laporanPembelianLunas');
