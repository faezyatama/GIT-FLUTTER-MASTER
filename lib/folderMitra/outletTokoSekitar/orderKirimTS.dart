...
import 'detailPesananKirimTS.dart';

class OrderKirimTS extends StatefulWidget {
  @override
  _OrderKirimTSState createState() => _OrderKirimTSState();
}

class _OrderKirimTSState extends State<OrderKirimTS> {
  ...
  cekOrderBerlangsung() async {
    ...
    var url =
        Uri.parse('${c.baseURLtokosekitar}/mobileAppsOutlet/listOrderKirimTS');
      ...
      order.add(Container(
        child: GestureDetector(
          child: Card(
              child: GestureDetector(
            onTap: () {
              Get.to(() => DetailBelanjaanKirimTS(kodePesanan: ord[6]));
            },
            child: Container(
                          ...
                          child: Column(
                            children: [
                              Text(
                                ...
                                textAlign: TextAlign.center,
                                style:
                                    TextStyle(color: Warna.putih, fontSize: 9),
                              ),
                              Text(
                                ord[5],
                                textAlign: TextAlign.center,
