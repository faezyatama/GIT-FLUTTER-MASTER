...
import 'detailPesananTS.dart';

class OrderMasukTS extends StatefulWidget {
  @override
  _OrderMasukTSState createState() => _OrderMasukTSState();
}

class _OrderMasukTSState extends State<OrderMasukTS> {
  ...
  cekOrderBerlangsung() async {
    ...
    var url =
        Uri.parse('${c.baseURLtokosekitar}/mobileAppsOutlet/listOrderMasukTS');
      ...
      order.add(Container(
        child: GestureDetector(
          child: Card(
              child: GestureDetector(
            onTap: () {
              Get.to(() => DetailBelanjaanTS(kodePesanan: ord[6]));
            },
            child: Container(
