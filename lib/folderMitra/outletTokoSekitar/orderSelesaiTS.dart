...
class OrderSelesaiTS extends StatefulWidget {
  @override
  _OrderSelesaiTSState createState() => _OrderSelesaiTSState();
}

class _OrderSelesaiTSState extends State<OrderSelesaiTS> {
  ...
  cekOrderBerlangsung() async {
    ...
    var url = Uri.parse(
        '${c.baseURLtokosekitar}/mobileAppsOutlet/listOrderSelesaiTS');
      ...
      order.add(Container(
        child: GestureDetector(
          child: Card(
              child: GestureDetector(
            onTap: () {
              Get.to(() => DetailBelanjaanSelesaiTS(kodePesanan: ord[6]));
            },
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      Get.to(
                          () => DetailBelanjaanSelesaiTS(kodePesanan: ord[6]));
                    },
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
