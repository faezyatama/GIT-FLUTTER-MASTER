...
class SetLokasiOutletTS extends StatefulWidget {
  @override
  _SetLokasiOutletTSState createState() => _SetLokasiOutletTSState();
}

class _SetLokasiOutletTSState extends State<SetLokasiOutletTS> {
              ...
              children: [
                ...
                Row(
                  children: [
                    ElevatedButton(
                        onPressed: () {
                          c.latOutletTSKU.value = c.tempLat.value;
                          c.longOutletTSKU.value = c.tempLong.value;
                          Get.back();
                        },
  ...
  void carilokasigoogle() async {
    ...
    var url =
        Uri.parse('${c.baseURLtokosekitar}/mobileAppsOutlet/cekalamatgoogle');
