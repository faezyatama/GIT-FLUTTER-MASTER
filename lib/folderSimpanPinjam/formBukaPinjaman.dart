...
import '../camera/kameraPinjaman.dart';
import 'sedangDalamProses.dart';

class FormBukaPinjaman extends StatefulWidget {
  @override
  State<FormBukaPinjaman> createState() => _FormBukaPinjamanState();
}

class _FormBukaPinjamanState extends State<FormBukaPinjaman> {
  ...
  final ctrlJaminan = TextEditingController();
  ...
  final ctrlKTPPasangan = TextEditingController();
  final ctrlNamaPasangan = TextEditingController();
  final ctrlTempatLahirPasangan = TextEditingController();
  final ctrlTanggalLahirPasangan = TextEditingController();
  final ctrlHpPasangan = TextEditingController();
  final ctrlAlamatPasangan = TextEditingController();
  final ctrlPekerjaanPasangan = TextEditingController();
  final ctrlreferensi = TextEditingController();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Formulir Pengajuan Kredit"),
      ),
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                      ...
                      labelText: 'Nominal Kredit yang dibutuhkan (Rp)',
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                      ...
                      labelText: 'Jangka Waktu Pengembalian (Bulan)',
                      border: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(10))),
                ),
                Padding(padding: EdgeInsets.only(top: 5)),
                ...
                TextField(
                  ...
                  style: TextStyle(
                      ...
                      fontWeight: FontWeight.w600,
                      color: Warna.grey),
                  controller: ctrlKTPPasangan,
                  keyboardType: TextInputType.number,
                  decoration: InputDecoration(
                      prefixIcon: Icon(Icons.card_membership),
                      labelText: 'Nomor KTP/SIM Pasangan',
                      border: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(10))),
                ),
                ...
                TextField(
                  ...
                  style: TextStyle(
                      ...
                      fontWeight: FontWeight.w600,
                      color: Warna.grey),
                  controller: ctrlTempatLahirPasangan,
                  keyboardType: TextInputType.text,
                  decoration: InputDecoration(
                      prefixIcon: Icon(Icons.map_sharp),
                ...
                GestureDetector(
                  onTap: () {
                    DatePicker.showDatePicker(context,
                      ...
                      ctrlTanggalLahirPasangan.text = date.day.toString() +
                          '-' +
                          date.month.toString() +
                          '-' +
                          date.year.toString();
                  ...
                  child: AbsorbPointer(
                    child: TextField(
                      ...
                      style: TextStyle(
                          ...
                          fontWeight: FontWeight.w600,
                          color: Warna.grey),
                      controller: ctrlTanggalLahirPasangan,
                      keyboardType: TextInputType.text,
                      decoration: InputDecoration(
                          prefixIcon: Icon(Icons.calendar_month),
                          labelText: 'Tanggal Lahir',
                ...
                TextField(
                  ...
                  style: TextStyle(
                      ...
                      fontWeight: FontWeight.w600,
                      color: Warna.grey),
                  controller: ctrlHpPasangan,
                  keyboardType: TextInputType.number,
                  decoration: InputDecoration(
                      prefixIcon: Icon(Icons.phone),
                      labelText: 'No Telepon / HP Pasangan',
                      border: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(10))),
                ),
                Padding(padding: EdgeInsets.only(top: 5)),
                TextField(
                  ...
                  style: TextStyle(
                      ...
                      fontWeight: FontWeight.w600,
                      color: Warna.grey),
                  controller: ctrlAlamatPasangan,
                  keyboardType: TextInputType.text,
                  decoration: InputDecoration(
                      prefixIcon: Icon(Icons.card_travel),
                      labelText: 'Alamat Pasangan',
                      border: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(10))),
                ),
                Padding(padding: EdgeInsets.only(top: 5)),
                TextField(
                  ...
                  style: TextStyle(
                      ...
                      fontWeight: FontWeight.w600,
                      color: Warna.grey),
                  controller: ctrlPekerjaanPasangan,
                  keyboardType: TextInputType.text,
                  decoration: InputDecoration(
                      prefixIcon: Icon(Icons.card_travel),
                ...
                Padding(padding: EdgeInsets.only(top: 22)),
                Text(
                  '3. Foto KTP Pasangan / Suami /Istri',
                  style: TextStyle(fontSize: 14, color: Warna.grey),
                ),
                GestureDetector(
                  onTap: () {
                    c.uploadTo.value = 'istri';
                    Get.to(() => CameraPinjaman());
                  },
                  child: SizedBox(
                    width: Get.width * 0.75,
                    child: Obx(() => CachedNetworkImage(
                        fit: BoxFit.fill,
                        imageUrl: c.fileKTPIstriDisplay.value,
                        errorWidget: (context, url, error) {
                          print(error);
                          return Icon(Icons.error);
                        })),
                ...
                GestureDetector(
                  ...
                  child: SizedBox(
                    ...
                    child: Obx(() => CachedNetworkImage(
                        fit: BoxFit.fill,
                        imageUrl: c.fileBerkasDisplay1.value,
                        errorWidget: (context, url, error) {
                          print(error);
                          return Icon(Icons.error);
                        })),
                ...
                GestureDetector(
                  ...
                  child: SizedBox(
                    ...
                    child: Obx(() => CachedNetworkImage(
                        fit: BoxFit.fill,
                        imageUrl: c.fileBerkasDisplay2.value,
                        errorWidget: (context, url, error) {
                          print(error);
                          return Icon(Icons.error);
                        })),
                ...
                GestureDetector(
                  ...
                  child: SizedBox(
                    ...
                    child: Obx(() => CachedNetworkImage(
                        fit: BoxFit.fill,
                        imageUrl: c.fileBerkasDisplay3.value,
                        errorWidget: (context, url, error) {
                          print(error);
                          return Icon(Icons.error);
                        })),
                ...
                GestureDetector(
                  ...
                  child: SizedBox(
                    ...
                    child: Obx(() => CachedNetworkImage(
                        fit: BoxFit.fill,
                        imageUrl: c.fileBerkasDisplay4.value,
                        errorWidget: (context, url, error) {
                          print(error);
                          return Icon(Icons.error);
                        })),
                ...
                Row(
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: Text(
                        'Data yang diberikan adalah data sebenarnya untuk mengajukan pinjaman.',
                        style: TextStyle(fontSize: 14, color: Warna.grey),
                        maxLines: 4,
                      ),
                    ),
  ...
  validasiRequest() {
    ...
    if (ctrlNominal.text == '') {
      Get.snackbar('Periksa Jumlah Pengajuan Kredit',
          'lengkapi data dan coba kirimkan kembali',
          snackPosition: SnackPosition.BOTTOM);
    } else if (ctrlTenor.text == '') {
      Get.snackbar(
          'Periksa Jangka Waktu', 'lengkapi data dan coba kirimkan kembali',
          snackPosition: SnackPosition.BOTTOM);
    } else if (ctrlJaminan.text == '') {
      Get.snackbar('Periksa Jaminan', 'lengkapi data dan coba kirimkan kembali',
          snackPosition: SnackPosition.BOTTOM);
    } else if (ctrlKtp.text == '') {
      Get.snackbar(
      ...
      Get.snackbar(
          'Periksa Kecamatan', 'lengkapi data dan coba kirimkan kembali',
          snackPosition: SnackPosition.BOTTOM);
    } else if (ctrlKTPPasangan.text == '') {
      Get.snackbar(
          'Periksa KTP Pasangan', 'lengkapi data dan coba kirimkan kembali',
          snackPosition: SnackPosition.BOTTOM);
    } else if (ctrlNamaPasangan.text == '') {
      Get.snackbar(
          'Periksa Nama Pasangan', 'lengkapi data dan coba kirimkan kembali',
          snackPosition: SnackPosition.BOTTOM);
    } else if (ctrlTempatLahirPasangan.text == '') {
      Get.snackbar('Periksa Tempat Lahir Pasangan',
          'lengkapi data dan coba kirimkan kembali',
          snackPosition: SnackPosition.BOTTOM);
    } else if (ctrlTanggalLahirPasangan.text == '') {
      Get.snackbar(
          'Periksa Tanggal Lahir', 'lengkapi data dan coba kirimkan kembali',
          snackPosition: SnackPosition.BOTTOM);
    } else if (ctrlHpPasangan.text == '') {
      Get.snackbar(
          'Periksa HP Pasangan', 'lengkapi data dan coba kirimkan kembali',
          snackPosition: SnackPosition.BOTTOM);
    } else if (ctrlAlamatPasangan.text == '') {
      Get.snackbar(
          'Periksa Alamat Pasangan', 'lengkapi data dan coba kirimkan kembali',
          snackPosition: SnackPosition.BOTTOM);
    } else if (ctrlPekerjaanPasangan.text == '') {
      Get.snackbar('Periksa Pekerjaan Pasangan',
          'lengkapi data dan coba kirimkan kembali',
          snackPosition: SnackPosition.BOTTOM);
      ...
      Get.snackbar(
          ...
          snackPosition: SnackPosition.BOTTOM);
    } else if (c.fileKTPIstri.value == '') {
      Get.snackbar('Periksa Foto KTP Pasangan',
          'lengkapi data dan coba kirimkan kembali',
          snackPosition: SnackPosition.BOTTOM);
  ...
  kirimDataPermohonanKredit() async {
    bool conn = await cekInternet();
    if (!conn) {
      return noInternetConnection();
    }
    ...
    var datarequest =
        '{"pid":"$pid","referensi":"${ctrlreferensi.text}","ttd":"${c.imageTTD}","berkas1":"${c.fileBerkas1.value}","berkas2":"${c.fileBerkas2.value}","berkas3":"${c.fileBerkas3.value}","berkas4":"${c.fileBerkas4.value}","ktpP":"${ctrlKTPPasangan.text}","namaP":"${ctrlNamaPasangan.text}","tempatLahirP":"${ctrlTempatLahirPasangan.text}","tanggalLahirP":"${ctrlTanggalLahirPasangan.text}","hpP":"${ctrlHpPasangan.text}","alamatP":"${ctrlAlamatPasangan.text}","pekerjaanP":"${ctrlPekerjaanPasangan.text}","nominal":"${ctrlNominal.text}","tenor":"${ctrlTenor.text}","jaminan":"${ctrlJaminan.text}","idProduk":"${c.idpinjaman}","produk":"${c.pinjamanPilihan}","ctrlKtp":"${ctrlKtp.text}","ctrlNamaLengkap":"${ctrlNamaLengkap.text}","ctrlTempatLahir":"${ctrlTempatLahir.text}","ctrlTglLahir":"${ctrlTglLahir.text}","ctrlHp":"${ctrlHp.text}","ctrlNpwp":"${ctrlNpwp.text}","ctrlNamaIbu":"${ctrlNamaIbu.text}","ctrlAlamatKtp":"${ctrlAlamatKtp.text}","ctrlAlamatDomisili":"${ctrlAlamatDomisili.text}","ctrlAlamatInstansi":"${ctrlAlamatInstansi.text}","ctrlPekerjaan":"${ctrlPekerjaan.text}","ctrlJabatan":"${ctrlJabatan.text}","ctrlInstansi":"${ctrlInstansi.text}","pilihanProvinsi":"$pilihanProvinsi","pilihanKabupaten":"$pilihanKabupaten","pilihanKecamatan":"$pilihanKecamatan","pilihanProvinsi2":"$pilihanProvinsi2","pilihanKabupaten2":"$pilihanKabupaten2","pilihanKecamatan2":"$pilihanKecamatan2","fileKTP":"${c.fileKTP.value}","fileKTPIstri":"${c.fileKTPIstri.value}","filePasFoto":"${c.filePasFoto.value}"}';
    var bytes = utf8.encode(datarequest + '$token' + user);
    var signature = md5.convert(bytes).toString();
    var url = Uri.parse('${c.baseURL}/mobileApps/permohonanKreditOnline');
    ...
    if (response.statusCode == 200) {
      ...
      if (hasil['status'] == 'success') {
        ...
        AwesomeDialog(
            ...
            desc:
                'Permohonan pengajuan pinjaman telah terkirim dan akan segera diperiksa. Informasi akan dikirimkan melalui whatsapp ke nomor terdaftar',
            btnOkOnPress: () {
              Get.back();
              Get.back();
  ...
  bersihkanFormulir() {
    ...
    c.fileKTPIstriDisplay.value =
        'https://images.sasuka.online/umum/selfie.png';
    c.filePasFotoDisplay.value =
        'https://images.sasuka.online/umum/pasfoto.jpg';
    c.fileBerkasDisplay1.value =
        'https://images.sasuka.online/umum/uploadberkas.jpg';
    c.fileBerkasDisplay2.value =
        'https://images.sasuka.online/umum/uploadberkas.jpg';
    c.fileBerkasDisplay3.value =
        'https://images.sasuka.online/umum/uploadberkas.jpg';
    c.fileBerkasDisplay4.value =
        'https://images.sasuka.online/umum/uploadberkas.jpg';
  }
}
