...
class LihatProdukSimpanan extends StatefulWidget {
  @override
  State<LihatProdukSimpanan> createState() => _LihatProdukSimpananState();
}

class _LihatProdukSimpananState extends State<LihatProdukSimpanan> {
  ...
  produkSimpanan() async {
    ...
    var url = Uri.parse('${c.baseURL}/mobileApps/produkSimpananUmum');
