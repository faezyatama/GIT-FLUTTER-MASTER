...
class LihatProdukSimpananBerjangka extends StatefulWidget {
  @override
  State<LihatProdukSimpananBerjangka> createState() =>
      _LihatProdukSimpananBerjangkaState();
}

class _LihatProdukSimpananBerjangkaState
    extends State<LihatProdukSimpananBerjangka> {
  ...
  produkSimpanan() async {
    ...
    var url = Uri.parse('${c.baseURL}/mobileApps/produkSimpananBerjangka');
      ...
      for (var i = 0; i < dataMentah.length; i++) {
        ...
        listProduk.add(
          Container(
            ...
            onTap: () {
              c.jenisSimpanan = 'Simpanan Berjangka';
