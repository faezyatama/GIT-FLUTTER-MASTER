...
class AntaranSelesai extends StatefulWidget {
  @override
  _AntaranSelesaiState createState() => _AntaranSelesaiState();
}

class _AntaranSelesaiState extends State<AntaranSelesai> {
  ...
  cekOrderBerlangsung() async {
    ...
    var url = Uri.parse('${c.baseURLdriver}/mobileAppsUser/antaranSelesai');
