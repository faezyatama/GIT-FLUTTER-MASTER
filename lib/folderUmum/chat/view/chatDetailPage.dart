...
class _ChatDetailPageState extends State<ChatDetailPage> {
          ...
          child: Container(
            ...
            child: Row(
              children: <Widget>[
                ...
                CircleAvatar(
                  backgroundImage: NetworkImage(c.fotoChatLawan.value),
  ...
  detailPageChat() async {
    ...
    if (conn) {
      ...
      var idlawan = c.idChatLawan.value;
      ...
      var url = Uri.parse('${c.baseURLchat}/mobileApps/detailChat');
  ...
  kirimChat() async {
    ...
    if (conn) {
      ...
      var url = Uri.parse('${c.baseURLchat}/mobileApps/sendChat');
