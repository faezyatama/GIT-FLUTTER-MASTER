...
import '/camera/GaleriChatSupport.dart';

import '../models/chatMessegeModel.dart';

import 'package:pull_to_refresh/pull_to_refresh.dart';

class LiveSupportChatDetailPage extends StatefulWidget {
  @override
  _LiveSupportChatDetailPageState createState() =>
      _LiveSupportChatDetailPageState();
}

class _LiveSupportChatDetailPageState extends State<LiveSupportChatDetailPage> {
  @override
  void initState() {
    super.initState();
    detailPageChat();
  ...
  detailPageChat() async {
    ...
    if (conn) {
      ...
      var url = Uri.parse('${c.baseURLchat}/mobileApps/detailChatSupport');
  ...
  kirimChat() async {
    ...
    if (conn) {
      ...
      var url = Uri.parse('${c.baseURLchat}/mobileApps/sendChatSupport');
