...
class LokasidanKeranjangFM extends StatefulWidget {
  @override
  _LokasidanKeranjangFMState createState() => _LokasidanKeranjangFMState();
}

class _LokasidanKeranjangFMState extends State<LokasidanKeranjangFM> {
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Obx(() => RawMaterialButton(
                          onPressed: () {
                            if (c.pilihanKurirFm.value == 'kurir') {
                            } else {
                              pilihanbutton('kurir');
                            }
                          },
  ...
  rekapBelanjadanAlamat() async {
    ...
    var jsonorder = jsonEncode(c.keranjangFm);
    ...
    var url =
        Uri.parse('${c.baseURLfreshmart}/mobileAppsUser/chekoutFreshmart');
    ...
    if (response.statusCode == 200) {
      ...
      if (hasil['status'] == 'success') {
        ...
        c.ongkirFm.value = hasil['ongkir'];
        c.jumlahItemFm.value = hasil['jumlahItem'];
        c.hargaKeranjangFm.value = hasil['hargaTotal'];
        c.namaoutletpadakeranjangFm.value = hasil['namaOutlet'];
        c.pilihanKurirFm.value = 'kurir';
        setState(() {
          c.alamatKirimFm.value = hasil['alamat'];
          dataSiap = true;
        });
      }
    }
  ...
  pengurangan(intHarga, itemid, indx) {
    if (c.jumlahBarangFm.value > 0) {
      if (indexQuantity[indx] > 1) {
        ...
        c.hargaKeranjangFm.value = c.hargaKeranjangFm.value - hrgSatuan;
        var kurang = 0;
  ...
  void pilihanbutton(kurir) {
    if (c.pilihanKurirFm.value == 'kurir') {
      c.pilihanKurirFm.value = 'sendiri';

      clearbutton();
      fill1.value = Warna.warnautama;
      text1.value = Warna.putih;

      c.hargaKeranjangFm.value = c.hargaKeranjangFm.value - c.ongkirFm.value;
    } else if (c.pilihanKurirFm.value == 'sendiri') {
      c.pilihanKurirFm.value = 'kurir';
      clearbutton();
