...
class TrackingDriverMP extends StatefulWidget {
  @override
  _TrackingDriverMPState createState() => _TrackingDriverMPState();
}

class _TrackingDriverMPState extends State<TrackingDriverMP> {
              ...
              child: RawMaterialButton(
                onPressed: () {
                  AwesomeDialog(
                    ...
                    title: 'Pembatalan Pesanan Paket',
                    desc:
                        ...
                        IconButton(
                            ...
                            onPressed: () {
                              Get.to(() => DetailBelanjaan(
                                  kodePesanan: c.kodetransaksiMP.value));
                            }),
                        IconButton(
  ...
  cekLokasidanOutlet() async {
    ...
    if (cekin == true) {
      ...
      var kodetrx = c.kodetransaksiMP.value;
      ...
      var url = Uri.parse('${c.baseURL}/sasuka/showmapMP');
  ...
  void batalkanPesananini() async {
    ...
    if (cekin == true) {
      ...
      var url = Uri.parse('${c.baseURL}/sasuka/batalkanPesananMP');
  ...
  trackingGpsDriver() async {
    ...
    if (cekin == true) {
      ...
      var url = Uri.parse('${c.baseURL}/sasuka/cekStatusdanLokasiMP');
        ...
        children: [
          ...
          Text('Barang Diterima',
              style: TextStyle(
                  ...
                  fontWeight: FontWeight.w600)),
          Text(
              'Terima kasih telah memesan produk bersama kami, Tolong berikan penilaian atas pelayanan kami',
              style: TextStyle(fontSize: 14, color: Colors.grey),
              textAlign: TextAlign.center),
          Padding(padding: EdgeInsets.only(top: 9)),
          SmoothStarRating(
  ...
  void pesananSelesai() async {
    ...
    if (cekin == true) {
      ...
      var url = Uri.parse('${c.baseURL}/sasuka/pesananSelesaiUserMP');
  ...
  cekStatusPengantaran() async {
    ...
    if (cekin == true) {
      ...
      var url = Uri.parse('${c.baseURL}/sasuka/cekStatusPengantaranMP');
