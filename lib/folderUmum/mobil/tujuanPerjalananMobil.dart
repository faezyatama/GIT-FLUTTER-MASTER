...
import '../mobil/penjemputanMobil.dart';

const double CAMERA_ZOOM = 16;
const double CAMERA_TILT = 0;
const double CAMERA_BEARING = 30;

class TujuanPerjalananMobil extends StatefulWidget {
  @override
  _TujuanPerjalananMobilState createState() => _TujuanPerjalananMobilState();
}

class _TujuanPerjalananMobilState extends State<TujuanPerjalananMobil> {
  ...
  Widget build(BuildContext context) {
    return (Scaffold(
        appBar: AppBar(
          title: Text(
            'Tujuan Perjalanan ' + c.nNamafitMobil,
          ),
                ...
                child: ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      if (c.loginAsPenggunaKita.value == 'Member') {
                        if (c.alamatTujuanMobil.value != '') {
                          c.latTujuanMobil.value = c.tempLat.value;
                          c.longTujuanMobil.value = c.tempLong.value;
                          Get.to(() => DimanaDijemputMobil());
                        } else {
  ...
  void carilokasigoogle() async {
    ...
    var url = Uri.parse('${c.baseURLdriver}/mobileAppsUser/cekTujuanMobil');
    ...
    if (response.statusCode == 200) {
      ...
      if (hasil['status'] == 'success') {
        ...
        c.ketTujuanMobil.value = controllerHp.text;
        c.alamatTujuanMobil.value = hasil['alamat'];
