...
class DimanaDijemput extends StatefulWidget {
  @override
  _DimanaDijemputState createState() => _DimanaDijemputState();
}

class _DimanaDijemputState extends State<DimanaDijemput> {
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                    ...
                    onPressed: () {
                      if (c.alamatJemput.value != '') {
                        c.latJemput.value = c.tempLatJemput.value;
                        c.longJemput.value = c.tempLongJemput.value;
  ...
  void carilokasigoogle() async {
    ...
    var url = Uri.parse('${c.baseURLdriver}/mobileAppsUser/cekJemput');
    ...
    if (response.statusCode == 200) {
      ...
      if (hasil['status'] == 'success') {
        ...
        c.ketJemput.value = controllerHp.text;
        c.alamatJemput.value = hasil['alamat'];
        c.latJemput.value = hasil['latitude'];
        c.longJemput.value = hasil['longitude'];
