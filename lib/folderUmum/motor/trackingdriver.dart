...
class TrackingDriverMotor extends StatefulWidget {
  @override
  _TrackingDriverMotorState createState() => _TrackingDriverMotorState();
}

class _TrackingDriverMotorState extends State<TrackingDriverMotor> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Perjalanan ' + c.nNamafitMotor),
  ...
  cekLokasidanOutlet() async {
    ...
    if (cekin == true) {
      ...
      var url =
          Uri.parse('${c.baseURLdriver}/mobileAppsUser/cekPetaPerjalanan');
  ...
  void batalkanPesananini() async {
    ...
    if (cekin == true) {
      ...
      var url = Uri.parse(
          '${c.baseURLdriver}/mobileAppsUser/batalkanPerjalananMotor');
  ...
  cekStatusPengantaran() async {
    ...
    if (cekin == true) {
      ...
      var url =
          Uri.parse('${c.baseURLdriver}/mobileAppsUser/cekStatusPengantaran');
  ...
  void perjalananSelesai() async {
    ...
    if (cekin == true) {
      ...
      var url =
          Uri.parse('${c.baseURLdriver}/mobileAppsUser/perjalananSelesaiUser');
  ...
  trackingGpsDriver() async {
    ...
    if (cekin == true) {
      ...
      var url =
          Uri.parse('${c.baseURLdriver}/mobileAppsUser/cekStatusdanLokasi');
