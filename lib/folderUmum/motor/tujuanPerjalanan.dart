...
import '../motor/penjemputan.dart';

const double CAMERA_ZOOM = 16;
const double CAMERA_TILT = 0;
const double CAMERA_BEARING = 30;

class TujuanPerjalananMotor extends StatefulWidget {
  @override
  _TujuanPerjalananMotorState createState() => _TujuanPerjalananMotorState();
}

class _TujuanPerjalananMotorState extends State<TujuanPerjalananMotor> {
                ...
                child: ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      if (c.loginAsPenggunaKita.value == 'Member') {
                        if (c.alamatTujuan.value != '') {
                          c.latTujuan.value = c.tempLat.value;
                          c.longTujuan.value = c.tempLong.value;
                          Get.to(() => DimanaDijemput());
                        } else {
                    ...
                    child: Text('Pilih alamat ini sebagai tujuan')),
              ),
            ],
          ),
        ),
  ...
  void onDragEnd(ltng) async {
    c.alamatTujuan.value = 'Alamat ditentukan pada koordinat peta';
  ...
  void carilokasigoogle() async {
    ...
    var url = Uri.parse('${c.baseURLdriver}/mobileAppsUser/cekTujuan');
    ...
    if (response.statusCode == 200) {
      ...
      if (hasil['status'] == 'success') {
        ...
        c.ketTujuan.value = controllerHp.text;
        c.alamatTujuan.value = hasil['alamat'];
