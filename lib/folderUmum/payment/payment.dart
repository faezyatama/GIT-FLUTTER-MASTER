...
class PaymentPoint extends StatefulWidget {
  @override
  _PaymentPointState createState() => _PaymentPointState();
}

class _PaymentPointState extends State<PaymentPoint> {
  @override
  void initState() {
    super.initState();
  ...
  void cekPembayaranTerbaru() async {
    ...
    var url = Uri.parse('${c.baseURL}/mobileApps/terbaru');
