...
class PaymentPointSaldo extends StatefulWidget {
  @override
  _PaymentPointSaldoState createState() => _PaymentPointSaldoState();
}

class _PaymentPointSaldoState extends State<PaymentPointSaldo> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Pembayaran Via Saldo'),
  ...
  void cekPembayaranTerbaru() async {
    ...
    var url = Uri.parse('${c.baseURL}/mobileApps/cekPembayaranSaldoSS');
  ...
  void prosesTransaksiIni() async {
    ...
    var url = Uri.parse('${c.baseURL}/mobileApps/prosesPembayaranViaSaldo');
