...
import 'detailBelanjaMakan.dart';
import '../samakan/trackingdriver.dart';
import 'package:smooth_star_rating/smooth_star_rating.dart';

import '../../../folderUmum/chat/view/chatDetailPage.dart';

class PesananBerlangsungMakanan extends StatefulWidget {
  @override
  _PesananBerlangsungMakananState createState() =>
      _PesananBerlangsungMakananState();
}

class _PesananBerlangsungMakananState extends State<PesananBerlangsungMakanan> {
  ...
  cekOrderBerlangsung() async {
    print('pesananBerlangsungMakanan');
    ...
    var url =
        Uri.parse('${c.baseURLmakan}/mobileAppsUser/pesananBerlangsungMakanan');
  ...
  void batalkanPesananini(String kodetrx) async {
    ...
    if (cekin == true) {
      ...
      var url = Uri.parse('${c.baseURLmakan}/mobileAppsUser/batalkanPesanan');
  ...
  void pesananSelesai(kode) async {
    ...
    if (cekin == true) {
      ...
      var url =
          Uri.parse('${c.baseURLmakan}/mobileAppsUser/pesananSelesaiUserMakan');
      ...
      if (response.statusCode == 200) {
        Map<String, dynamic> hasil = jsonDecode(response.body);
        if (hasil['status'] == 'success') {
          Get.snackbar('Pesanan Makanan Selesai',
              'Terima kasih telah memesan makanan bersama kami');
