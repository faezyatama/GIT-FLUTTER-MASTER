...
import 'detailbarangbelanja.dart';

class PesananBerlangsungMarketplace extends StatefulWidget {
  @override
  _PesananBerlangsungMarketplaceState createState() =>
      _PesananBerlangsungMarketplaceState();
}

class _PesananBerlangsungMarketplaceState
    extends State<PesananBerlangsungMarketplace> {
  ...
  cekOrderBerlangsung() async {
    ...
    var url = Uri.parse(
        '${c.baseURLmp}/mobileAppsUser/pesananBerlangsungMarketplace');
  ...
  void batalkanPesananini(String kodetrx) async {
    ...
    if (cekin == true) {
      ...
      var url = Uri.parse('${c.baseURLmp}/mobileAppsUser/batalkanPesanan');
  ...
  void pesananSelesai(kode) async {
    ...
    if (cekin == true) {
      ...
      var url =
          Uri.parse('${c.baseURLmp}/mobileAppsUser/pesananSelesaiUserMakan');
  ...
  void pesananSelesaiFM(kode) async {
    ...
    if (cekin == true) {
      ...
      var url = Uri.parse('${c.baseURLmp}/mobileAppsUser/pesananSelesaiUserFM');
  ...
  void alertPesananSelesaiMP(kode) {
    var rating = 0.0;
    AwesomeDialog(
      context: Get.context,
      dialogType: DialogType.noHeader,
  ...
  void pesananSelesaiMP(kode) async {
    var cekin = await cekInternet();
    if (cekin == true) {
      var token = dbbox.get('token');
      var pid = dbbox.get('person_id');
      ...
      var url = Uri.parse('${c.baseURLmp}/mobileAppsUser/pesananSelesaiUserMP');
  ...
  updateState() async {
    ...
    var url = Uri.parse('${c.baseURLmp}/mobileAppsUser/pesananBerlangsung');
