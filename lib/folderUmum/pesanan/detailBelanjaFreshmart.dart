...
class DetailBelanjaanFreshmart extends StatefulWidget {
  DetailBelanjaanFreshmart({this.kodePesanan});
  final String kodePesanan;

  @override
  _DetailBelanjaanFreshmartState createState() =>
      _DetailBelanjaanFreshmartState();
}

class _DetailBelanjaanFreshmartState extends State<DetailBelanjaanFreshmart> {
  ...
  rekapBelanjadanAlamat() async {
    ...
    var url = Uri.parse('${c.baseURLfreshmart}/mobileAppsUser/detailBelanjaan');
