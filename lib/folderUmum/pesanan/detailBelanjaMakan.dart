...
class DetailBelanjaanMakan extends StatefulWidget {
  DetailBelanjaanMakan({this.kodePesanan});
  final String kodePesanan;

  @override
  _DetailBelanjaanMakanState createState() => _DetailBelanjaanMakanState();
}

class _DetailBelanjaanMakanState extends State<DetailBelanjaanMakan> {
  ...
  rekapBelanjadanAlamat() async {
    ...
    var url = Uri.parse('${c.baseURLmakan}/mobileAppsUser/detailBelanjaan');
