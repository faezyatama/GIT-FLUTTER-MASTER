...
class DetailBelanjaanTokoSekitar extends StatefulWidget {
  DetailBelanjaanTokoSekitar({this.kodePesanan});
  final String kodePesanan;

  @override
  _DetailBelanjaanTokoSekitarState createState() =>
      _DetailBelanjaanTokoSekitarState();
}

class _DetailBelanjaanTokoSekitarState
    extends State<DetailBelanjaanTokoSekitar> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Detail Belanjaan Toko Sekitar'),
      ),
      body: ListView(
        children: [
          Container(
  ...
  rekapBelanjadanAlamat() async {
    ...
    var url = Uri.parse(
        '${c.baseURLtokosekitar}/mobileAppsUser/detailBelanjaanTokoSekitar');
  ...
  void konfirmasiSudahTransfer() async {
    ...
    var url = Uri.parse('${c.baseURL}/sasuka/konfirmasiSudahTransfer');
