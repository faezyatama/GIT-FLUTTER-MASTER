...
class PesananSelesaiFreshmart extends StatefulWidget {
  @override
  _PesananSelesaiFreshmartState createState() =>
      _PesananSelesaiFreshmartState();
}

class _PesananSelesaiFreshmartState extends State<PesananSelesaiFreshmart> {
  ...
  cekHistoryOrder() async {
    ...
    var url = Uri.parse(
        '${c.baseURLfreshmart}/mobileAppsUser/pesananSelesaiFreshmart');
