...
class PesananSelesaiMarketPlace extends StatefulWidget {
  @override
  _PesananSelesaiMarketPlaceState createState() =>
      _PesananSelesaiMarketPlaceState();
}

class _PesananSelesaiMarketPlaceState extends State<PesananSelesaiMarketPlace> {
  ...
  cekHistoryOrder() async {
    ...
    var url =
        Uri.parse('${c.baseURLmp}/mobileAppsUser/pesananSelesaiMarketplace');
