...
class PesananSelesaiMakanan extends StatefulWidget {
  @override
  _PesananSelesaiMakananState createState() => _PesananSelesaiMakananState();
}

class _PesananSelesaiMakananState extends State<PesananSelesaiMakanan> {
  ...
  cekHistoryOrder() async {
    ...
    var url =
        Uri.parse('${c.baseURLmakan}/mobileAppsUser/pesananSelesaiMakanan');
