...
class DimanaDijemputPickup extends StatefulWidget {
  @override
  _DimanaDijemputPickupState createState() => _DimanaDijemputPickupState();
}

class _DimanaDijemputPickupState extends State<DimanaDijemputPickup> {
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                    ...
                    onPressed: () {
                      if (c.alamatJemputPickup.value != '') {
                        c.latJemputPickup.value = c.tempLatJemput.value;
                        c.longJemputPickup.value = c.tempLongJemput.value;
  ...
  void onDragEnd(ltng) async {
    c.alamatJemputPickup.value = 'Alamat ditentukan pada koordinat peta';
  ...
  void carilokasigoogle() async {
    ...
    var url = Uri.parse('${c.baseURLdriver}/mobileAppsUser/cekJemputPickup');
    ...
    if (response.statusCode == 200) {
      ...
      if (hasil['status'] == 'success') {
        ...
        c.ketJemputPickup.value = controllerHp.text;
        c.alamatJemputPickup.value = hasil['alamat'];
        c.latJemputPickup.value = hasil['latitude'];
        c.longJemputPickup.value = hasil['longitude'];
