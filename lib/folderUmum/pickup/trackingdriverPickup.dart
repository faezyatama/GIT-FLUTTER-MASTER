...
class TrackingDriverPickup extends StatefulWidget {
  @override
  _TrackingDriverPickupState createState() => _TrackingDriverPickupState();
}

class _TrackingDriverPickupState extends State<TrackingDriverPickup> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Perjalanan ' + c.nNamafitPickup),
  ...
  void batalkanPesananini() async {
    ...
    if (cekin == true) {
      ...
      var url = Uri.parse(
          '${c.baseURLdriver}/mobileAppsUser/batalkanPerjalananPickup');
  ...
  cekStatusPengantaran() async {
    ...
    if (cekin == true) {
      ...
      var url = Uri.parse(
          '${c.baseURLdriver}/mobileAppsUser/cekStatusPengantaranPickup');
  ...
  void perjalananSelesai() async {
    ...
    if (cekin == true) {
      ...
      var url = Uri.parse(
          '${c.baseURLdriver}/mobileAppsUser/perjalananSelesaiUserPickup');
  ...
  trackingGpsDriver() async {
    ...
    if (cekin == true) {
      ...
      var url = Uri.parse(
          '${c.baseURLdriver}/mobileAppsUser/cekStatusdanLokasiPickup');
