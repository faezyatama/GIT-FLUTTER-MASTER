...
class CariLokasiKirim extends StatefulWidget {
  @override
  _CariLokasiKirimState createState() => _CariLokasiKirimState();
}

class _CariLokasiKirimState extends State<CariLokasiKirim> {
              ...
              children: [
                ...
                Row(
                  children: [
                    ElevatedButton(
                        onPressed: () {
                          c.latitude.value = c.tempLat.value;
                          c.longitude.value = c.tempLong.value;
                          Get.off(LokasidanKeranjangMK());
                        },
  ...
  void carilokasigoogle() async {
    ...
    var url = Uri.parse('${c.baseURL}/sasuka/cekalamatgoogle');
