...
class TrackingDriver extends StatefulWidget {
  @override
  _TrackingDriverState createState() => _TrackingDriverState();
}
...
class _TrackingDriverState extends State<TrackingDriver> {
              ...
              child: RawMaterialButton(
                onPressed: () {
                  AwesomeDialog(
                    ...
                    title: 'Pembatalan Pesanan Makanan',
                    desc:
                        ...
                        IconButton(
                            ...
                            onPressed: () {
                              Get.to(() => DetailBelanjaan(
                                  kodePesanan: c.kodetransaksimakan.value));
                            }),
                        IconButton(
  ...
  cekLokasidanOutlet() async {
    ...
    if (cekin == true) {
      ...
      var kodetrx = c.kodetransaksimakan.value;
  ...
  trackingGpsDriver() async {
    ...
    if (cekin == true) {
      ...
      var url = Uri.parse('${c.baseURL}/sasuka/cekStatusdanLokasiMakan');
  ...
  void pesananSelesai() async {
    ...
    if (cekin == true) {
      ...
      var url = Uri.parse('${c.baseURL}/sasuka/pesananSelesaiUserMakan');
  ...
  cekStatusPengantaran() async {
    ...
    if (cekin == true) {
      ...
      var url = Uri.parse('${c.baseURL}/sasuka/cekStatusPengantaranMakan');
