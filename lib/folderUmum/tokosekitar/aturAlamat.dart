...
class AturAlamatKirimTokoSekitar extends StatefulWidget {
  @override
  _AturAlamatKirimTokoSekitarState createState() =>
      _AturAlamatKirimTokoSekitarState();
}

class _AturAlamatKirimTokoSekitarState
    extends State<AturAlamatKirimTokoSekitar> {
  ...
  void kirimAlamatBaru() async {
    ...
    var url = Uri.parse('${c.baseURL}/sasuka/saveAlamatBaru');
  ...
  void cekAlamatTersedia() async {
    ...
    var url = Uri.parse('${c.baseURL}/sasuka/cekAlamatTersedia');
