...
class CariLokasiKirimTS extends StatefulWidget {
  @override
  _CariLokasiKirimTSState createState() => _CariLokasiKirimTSState();
}

class _CariLokasiKirimTSState extends State<CariLokasiKirimTS> {
