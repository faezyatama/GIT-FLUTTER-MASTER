          ...
          Container(
            ...
            onTap: () {
              if (valHistory[9] == 'buka') {
                c.idOutletPilihanTOSEK.value = valHistory[1];

                if ((c.idOutletpadakeranjangTOSEK.value ==
                        c.idOutletPilihanTOSEK.value) ||
                    (c.idOutletpadakeranjangTOSEK.value == 0)) {
                  c.namaOutletTOSEK.value = valHistory[7];
                  c.tagIdTOSEKC.value = valHistory[1].toString();
                  c.namaTOSEKC.value = valHistory[2];
                  c.gambarTOSEKC.value = valHistory[3];
                  c.namaoutletTOSEKC.value = valHistory[7];
                  c.hargaTOSEKC.value = valHistory[5];
                  c.lokasiTOSEKC.value = valHistory[4];
                  c.deskripsiTOSEKC.value = valHistory[10];
                  c.hargaIntTOSEKC.value = valHistory[8];
                  c.idOutletTOSEKC.value = valHistory[1].toString();
                  c.itemIdTOSEKC.value = valHistory[11].toString();
