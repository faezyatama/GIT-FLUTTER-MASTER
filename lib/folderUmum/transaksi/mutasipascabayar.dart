...
class MutasiPascabayar extends StatefulWidget {
  @override
  _MutasiPascabayarState createState() => _MutasiPascabayarState();
}

class _MutasiPascabayarState extends State<MutasiPascabayar> {
  ...
  loadDataMutasi(halaman) async {
    ...
    var url = Uri.parse('${c.baseURL}/mobileApps/mutasiPasca');
                  ...
                  body: Column(
                    children: [
                        ...
                        onPressed: () {
                          if ((hargaDiatur == 'Sendiri')) {
                            if ((controllerHarga.text == '')) {
                              ...
                              c.barisCetak1.value = mutasi[8];
                              c.barisCetak2.value = mutasi[9];
                              c.barisCetak3.value = mutasi[10];
                              c.barisCetak4.value = mutasi[11];
                              c.barisCetak5.value = mutasi[12];
                              c.barisCetak6.value = mutasi[13];
                              c.barisCetak7.value = mutasi[14];
                              c.barisCetak8.value = mutasi[15];
                              c.hargaCetak.value =
                      ...
                      RawMaterialButton(
                        ...
                        onPressed: () {
                          Get.back();
                          Share.share(mutasi[7], subject: 'Share Transaksi');
                        },
                      ),
                    ],
                  ),
