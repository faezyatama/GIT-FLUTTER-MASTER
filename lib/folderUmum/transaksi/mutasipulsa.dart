...
class MutasiPulsa extends StatefulWidget {
  @override
  _MutasiPulsaState createState() => _MutasiPulsaState();
}

class _MutasiPulsaState extends State<MutasiPulsa> {
  ...
  loadDataMutasi(halaman) async {
    ...
    var url = Uri.parse('${c.baseURL}/mobileApps/mutasiPulsa');
