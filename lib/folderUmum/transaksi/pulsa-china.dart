...
class PulsaChina extends StatefulWidget {
  @override
  _PulsaChinaState createState() => _PulsaChinaState();
}

class _PulsaChinaState extends State<PulsaChina> {
  @override
  void initState() {
    super.initState();
    c.kodepulsa.value = '';
  ...
  cekPulsaTersedia() async {
    ...
    var datarequest =
        '{"pid":"$pid","operator":"$operator","jenis":"China TOPUP"}';
                  ...
                  SingleChildScrollView(
                    ...
                    child: Row(
                      children: [
                        GestureDetector(
                          onTap: () {
                            c.operatorpilihan.value = 'CHINA TOPUP';
                            cekPulsaTersedia();
                            setState(() {
                              alloffwarna();
                            ...
                            child: Card(
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Image.asset(
                                        'images/logopulsa/CHINA TOPUP.png',
                                        width: Get.width * 0.2,
