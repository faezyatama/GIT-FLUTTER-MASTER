...
class PulsaData extends StatefulWidget {
  @override
  _PulsaDataState createState() => _PulsaDataState();
}

class _PulsaDataState extends State<PulsaData> {
  @override
  void initState() {
    super.initState();
    c.kodepulsa.value = '';
  ...
  cekPulsaTersedia() async {
    ...
    var datarequest = '{"pid":"$pid","operator":"$operator","jenis":"Data"}';
