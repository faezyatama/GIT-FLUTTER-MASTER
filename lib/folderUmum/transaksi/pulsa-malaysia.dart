...
class PulsaMalaysia extends StatefulWidget {
  @override
  _PulsaMalaysiaState createState() => _PulsaMalaysiaState();
}

class _PulsaMalaysiaState extends State<PulsaMalaysia> {
  @override
  void initState() {
    super.initState();
    c.kodepulsa.value = '';
  ...
  cekPulsaTersedia() async {
    ...
    var datarequest =
        '{"pid":"$pid","operator":"$operator","jenis":"Malaysia TOPUP"}';
                  ...
                  SingleChildScrollView(
                    ...
                    child: Row(
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            c.operatorpilihan.value = 'CELCOM';
                            cekPulsaTersedia();
                        ...
                        GestureDetector(
                          onTap: () {
                            c.operatorpilihan.value = 'UMOBILE';
                            cekPulsaTersedia();
                        ...
                        GestureDetector(
                          onTap: () {
                            c.operatorpilihan.value = 'TUNETALK';
                            cekPulsaTersedia();
