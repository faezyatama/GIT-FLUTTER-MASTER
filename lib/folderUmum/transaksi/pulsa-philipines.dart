...
class PulsaPhilipines extends StatefulWidget {
  @override
  _PulsaPhilipinesState createState() => _PulsaPhilipinesState();
}

class _PulsaPhilipinesState extends State<PulsaPhilipines> {
  @override
  void initState() {
    super.initState();
    c.kodepulsa.value = '';
  ...
  cekPulsaTersedia() async {
    ...
    var datarequest =
        '{"pid":"$pid","operator":"$operator","jenis":"Philippines TOPUP"}';
                  ...
                  SingleChildScrollView(
                    ...
                    child: Row(
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            c.operatorpilihan.value = 'PHILIPPINES - SMART';
                            cekPulsaTersedia();
                            ...
                            child: Card(
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Image.asset(
                                        'images/logopulsa/PHILIPPINES - SMART.png',
                                        width: Get.width * 0.2,
                                        height: Get.width * 0.2,
                                        fit: BoxFit.contain,
                                      ),
                        ...
                        GestureDetector(
                          onTap: () {
                            c.operatorpilihan.value = 'SMART PINOY';
                            cekPulsaTersedia();
                            ...
                            child: Card(
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Image.asset(
                                        'images/logopulsa/SMART PINOY.png',
                                        width: Get.width * 0.2,
                                        height: Get.width * 0.2,
                                        fit: BoxFit.contain,
                                      ),
                        ...
                        GestureDetector(
                          onTap: () {
                            c.operatorpilihan.value = 'SUN TELECOM';
                            cekPulsaTersedia();
                            ...
                            child: Card(
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Image.asset(
                                        'images/logopulsa/SUN TELECOM.png',
                                        width: Get.width * 0.2,
                                        height: Get.width * 0.2,
                                        fit: BoxFit.contain,
                                      ),
