...
class PulsaSingapore extends StatefulWidget {
  @override
  _PulsaSingaporeState createState() => _PulsaSingaporeState();
}

class _PulsaSingaporeState extends State<PulsaSingapore> {
  @override
  void initState() {
    super.initState();
    c.kodepulsa.value = '';
  ...
  cekPulsaTersedia() async {
    ...
    var datarequest =
        '{"pid":"$pid","operator":"$operator","jenis":"Singapore TOPUP"}';
  ...
  listdaftar() {
    ...
    if (dataHistory.length > 0) {
      for (var i = 0; i < dataHistory.length; i++) {
        ...
        listbank.add(
          Container(
              padding: EdgeInsets.only(left: 4, right: 4, bottom: 11),
              child: SizedBox(
                  ...
                  SingleChildScrollView(
                    ...
                    child: Row(
                      children: [
                        GestureDetector(
                          onTap: () {
                            c.operatorpilihan.value = 'SINGTEL';
                            cekPulsaTersedia();
                            setState(() {
                              alloffwarna();
                        ...
                        GestureDetector(
                          onTap: () {
                            c.operatorpilihan.value = 'STARHUB';
                            cekPulsaTersedia();
