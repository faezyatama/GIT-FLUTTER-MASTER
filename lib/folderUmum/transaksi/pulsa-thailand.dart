...
class ThailandTopup extends StatefulWidget {
  @override
  _ThailandTopupState createState() => _ThailandTopupState();
}

class _ThailandTopupState extends State<ThailandTopup> {
  @override
  void initState() {
    super.initState();
    c.kodepulsa.value = '';
  ...
  cekPulsaTersedia() async {
    ...
    var datarequest =
        '{"pid":"$pid","operator":"$operator","jenis":"Thailand TOPUP"}';
                  ...
                  SingleChildScrollView(
                    ...
                    child: Row(
                      children: [
                        GestureDetector(
                          onTap: () {
                            c.operatorpilihan.value = 'THAILAND TOPUP';
                            cekPulsaTersedia();
                            setState(() {
                              alloffwarna();
                            ...
                            child: Card(
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Image.asset(
                                        'images/logopulsa/THAILAND TOPUP.png',
                                        width: Get.width * 0.2,
