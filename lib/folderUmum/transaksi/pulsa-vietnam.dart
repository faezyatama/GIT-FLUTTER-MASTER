...
class PulsaVietnam extends StatefulWidget {
  @override
  _PulsaVietnamState createState() => _PulsaVietnamState();
}

class _PulsaVietnamState extends State<PulsaVietnam> {
  @override
  void initState() {
    super.initState();
    c.kodepulsa.value = '';
  ...
  cekPulsaTersedia() async {
    ...
    var datarequest =
        '{"pid":"$pid","operator":"$operator","jenis":"Vietnam TOPUP"}';
                  ...
                  SingleChildScrollView(
                    ...
                    child: Row(
                      children: [
                        GestureDetector(
                          onTap: () {
                            c.operatorpilihan.value = 'VIETNAM TOPUP';
                            cekPulsaTersedia();
                            setState(() {
                              alloffwarna();
                            ...
                            child: Card(
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Image.asset(
                                        'images/logopulsa/VIETNAM TOPUP.png',
                                        width: Get.width * 0.2,
