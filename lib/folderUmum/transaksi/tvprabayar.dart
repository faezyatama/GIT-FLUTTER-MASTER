...
class TVPrabayar extends StatefulWidget {
  @override
  _TVPrabayarState createState() => _TVPrabayarState();
}

class _TVPrabayarState extends State<TVPrabayar> {
  @override
  void initState() {
    super.initState();
    c.kodepulsa.value = '';
  ...
  cekPulsaTersedia() async {
    ...
    EasyLoading.show(status: 'Cek TV Prabayar...');
    ...
    var datarequest =
        '{"pid":"$pid","operator":"$operator","jenis":"$jenisPulsa"}';
                    ...
                    if (c.loginAsPenggunaKita.value == 'Member') {
                      if (controllerHp.text == '') {
                        AwesomeDialog(
                          ...
                          desc:
                              'Opps... sepertinya nomor tujuan pengisian TV Prabayar belum kamu masukan',
                          btnCancelText: 'Ok',
        ...
        Container(
          ...
          child: Column(children: [
            ...
            Container(
              ...
              child: Text(
                'Pilih operator untuk melihat nominal paket TV Prabayar yang tersedia',
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Text('Masukan ID/Decoder pelanggan :',
                  ...
                  Text(
                    'Pilih Operator / Penyedia Layanan :',
                    style: TextStyle(color: Warna.grey, fontSize: 16),
                  ),
                  ...
                  SingleChildScrollView(
                    ...
                    child: Row(
                      children: [
                        GestureDetector(
                          onTap: () {
                            c.operatorpilihan.value = 'Nex Parabola';
                            jenisPulsa = 'TV';
                            logoTV = 'images/logopulsa/NexParabola.png';
                            cekPulsaTersedia();
                            setState(() {
                              alloffwarna();
                            ...
                            child: Card(
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Image.asset(
                                        'images/logopulsa/NexParabola.png',
                                        width: Get.width * 0.4,
                                        fit: BoxFit.contain,
                                      ),
                        ...
                        GestureDetector(
                          onTap: () {
                            c.operatorpilihan.value = 'Decoder GOL';
                            jenisPulsa = 'TV';
                            logoTV = 'images/logopulsa/DecoderGOL.png';
                            cekPulsaTersedia();
                            ...
                            child: Card(
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Image.asset(
                                        'images/logopulsa/DecoderGOL.png',
                                        width: Get.width * 0.4,
                                        fit: BoxFit.contain,
                                      ),
                                      Padding(padding: EdgeInsets.only(top: 3)),
                        ...
                        GestureDetector(
                          onTap: () {
                            c.operatorpilihan.value = 'K-VISION dan GOL';
                            logoTV = 'images/logopulsa/K-VISIONdanGOL.png';
                            jenisPulsa = 'TV';
                            cekPulsaTersedia();
                            ...
                            child: Card(
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Image.asset(
                                        'images/logopulsa/K-VISIONdanGOL.png',
                                        width: Get.width * 0.4,
                                        fit: BoxFit.contain,
                                      ),
                                      Padding(padding: EdgeInsets.only(top: 3)),
                        ...
                        GestureDetector(
                          onTap: () {
                            c.operatorpilihan.value = 'Skynindo';
                            logoTV = 'images/logopulsa/Skynindo.png';
                            jenisPulsa = 'TV';
                            cekPulsaTersedia();
                        ...
                        GestureDetector(
                          onTap: () {
                            c.operatorpilihan.value = 'Transvision';
                            logoTV = 'images/logopulsa/Transvision.png';
                            jenisPulsa = 'TV';
                            cekPulsaTersedia();
                            ...
                            child: Card(
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Image.asset(
                                        'images/logopulsa/Transvision.png',
                                        width: Get.width * 0.4,
                                        fit: BoxFit.contain,
                                      ),
                                      Padding(padding: EdgeInsets.only(top: 3)),
                        ...
                        GestureDetector(
                          onTap: () {
                            c.operatorpilihan.value = 'Kawan Kvision';
                            logoTV = 'images/logopulsa/KawanKvision.png';
                            jenisPulsa = 'TV';
                            cekPulsaTersedia();
                            ...
                            child: Card(
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Image.asset(
                                        'images/logopulsa/KawanKvision.png',
                                        width: Get.width * 0.4,
                                        fit: BoxFit.contain,
                                      ),
                                      Padding(padding: EdgeInsets.only(top: 3)),
                        ...
                        GestureDetector(
                          onTap: () {
                            c.operatorpilihan.value = 'Jawara Vision';
                            logoTV = 'images/logopulsa/JawaraVision.png';
                            ...
                            child: Card(
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Image.asset(
                                        'images/logopulsa/JawaraVision.png',
                                        width: Get.width * 0.4,
                                        fit: BoxFit.contain,
                                      ),
                                      Padding(padding: EdgeInsets.only(top: 3)),
                        ...
                        GestureDetector(
                          onTap: () {
                            c.operatorpilihan.value =
                                'Matrix Garuda - Sinema - Mola Matrix';
                            jenisPulsa = 'TV';
                            logoTV = 'images/logopulsa/MatrixGaruda.png';
                            ...
                            child: Card(
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Image.asset(
                                        'images/logopulsa/MatrixGaruda.png',
                                        width: Get.width * 0.4,
                                        fit: BoxFit.contain,
                                      ),
                                      Padding(padding: EdgeInsets.only(top: 3)),
                        ...
                        GestureDetector(
                          onTap: () {
                            c.operatorpilihan.value = 'WeTV';
                            jenisPulsa = 'Streaming';
                            logoTV = 'images/logopulsa/WeTV.png';
    ...
    AwesomeDialog(
      ...
      body: Column(
        children: [
          ...
          Text(
              'Apakah kamu benar akan membeli paket TV Prabayar ke nomor tujuan dan nominal ini ?',
